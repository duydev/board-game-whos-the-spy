    ...
    <Card className="w-full">
      ...
      <CardContent>
        <div className="space-y-2">
          {player.role === 'spy' ? (
            <div>
              <p className="text-sm text-muted-foreground">{t('youAreSpy')}</p>
              <p className="text-lg font-semibold mt-2">{t('youDontKnowKeyword')}</p>
              {wordPair && (
                <div className="mt-4 p-3 bg-muted rounded-md">
                  <p className="text-sm text-muted-foreground">{t('wordPairInGame')}</p>
            ...
            <div>
              <p className="text-sm text-muted-foreground">{t('yourKeyword')}</p>
